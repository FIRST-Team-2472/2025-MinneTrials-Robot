...
public class TurnCMD extends Command {
    ...
    public void execute() {
        ...
        double speedNeeded = yawController.calculate(0, tankDriveSubsystem.getPose().getRotation().minus(targetAngle).getDegrees());
        tankDriveSubsystem.arcadeDrive(0.02, speedNeeded);
    }
